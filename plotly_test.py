...
def plot_fig(keyphrases, doc, cluster_size=5):
  ...
  color_converter = ['red', 'green', 'orange', 'blue', 'purple', 'black',
                     'yellow', 'goldenrod', 'magenta', 'pink', 'brown']
  ...
  fig = px.scatter(
    cluster_sample_df, x='component 0', y='component 1', hover_data='phrase', hover_name='phrase',
    color='color', color_discrete_map="identity", symbol='symbol', size=plot_size,
...
def plot_fig_3d(keyphrases, doc, cluster_size=5):
  ...
  symbols = []
  colors = []
  shape_converter = ['star', 'square', 'diamond', 'cross', 'x', 'hourglass', 'hexagona']
  color_converter = ['red', 'green', 'orange', 'blue', 'purple', 'black',
                     'yellow', 'goldenrod', 'magenta', 'pink', 'brown']
